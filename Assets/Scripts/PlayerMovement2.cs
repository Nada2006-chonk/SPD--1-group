...
public class PlayerMovement2 : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        float moveMultiplier = inLava ? 0.3f : 1f;

        rgbd.linearVelocity = new Vector2(horizontalValue * moveSpeed * moveMultiplier * Time.deltaTime, rgbd.linearVelocity.y);

        //Axis checker, animator (Neo)
        if (CheckIfGrounded() == true && !inLava)
        {
